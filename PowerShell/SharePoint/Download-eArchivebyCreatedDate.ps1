...
Examples:
  .\Download-eArchivebyCreatedDate.ps1 -ConditionListName "DocumentMetadata" -DryRun
  .\Download-eArchivebyCreatedDate.ps1 -ConditionListName "DocumentMetadata" -ListFields
  .\Download-eArchivebyCreatedDate.ps1 -ConditionListName "DocumentMetadata" -DocumentClassification "Restricted" -DisposeDate "2024-06-30" -DeleteAfterDownload
