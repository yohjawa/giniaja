...
$ListName ="E-ARCHIVES"
$OutPutFile = "D:\Tmp\eArchives.csv"
...
Do
{
    ...
    $ListItems | ForEach {
        ...
        # e-Archiving Properties
        $ExportItem | Add-Member -MemberType NoteProperty -name "Name" -value $_["Title"]
        $ExportItem | Add-Member -MemberType NoteProperty -name "FileName" -value $_["Name"]
        $ExportItem | Add-Member -MemberType NoteProperty -Name "Description" -value $_["VBOX Description"]
        $ExportItem | Add-Member -MemberType NoteProperty -name "Entities" -value $_["EP Doc Code:Entities_Using_Docs_String"]
        $ExportItem | Add-Member -MemberType NoteProperty -name "EntityString" -value $_["EP Doc Code:Metier_Using_Docs_String"]
        ...
        #vBOX Properties -- Need change $ListName to VBOX
        #$ExportItem | Add-Member -MemberType NoteProperty -name "Name" -value $_["Title"]
        #$ExportItem | Add-Member -MemberType NoteProperty -Name "Description" -value $_["VBOX Description"]
        #$ExportItem | Add-Member -MemberType NoteProperty -name "EP Code" -value $_["EP Code"]
        #$ExportItem | Add-Member -MemberType NoteProperty -name "IT Classification" -value $_["IT Classification"]
        ...
        #$ExportItem | Add-Member -MemberType NoteProperty -name "Modified By" -value $_["Modified By"]
